...
function ThemTaiKhoan(){
    ...
    var table = document.querySelector('.TableTK');
...
function XoaTatCaTK(){
    ...
    document.getElementById('row-SuaTK').style.opacity=0;
    document.getElementById('row-SuaTK').style.height="0px";

    document.getElementById('row-ThemTK').style.opacity=0;
    document.getElementById('row-ThemTK').style.height="0px";
}
